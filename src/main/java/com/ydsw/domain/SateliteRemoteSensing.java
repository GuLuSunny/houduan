...
/**
 * 卫星遥感
 * @TableName satelite_remote_sensing
 */
@TableName(value ="satelite_remote_sensing")
@Data
public class SateliteRemoteSensing implements Serializable {
    /**
     * 主键
     */
    ...
    * */
    ...
    public SateliteRemoteSensing() {}
    public SateliteRemoteSensing(String deviceName,String observationTime, Date createTime, String type,
                                 String typeDetail, String filepath,String filename,
    ...
    public boolean equals(Object that) {
        ...
        SateliteRemoteSensing other = (SateliteRemoteSensing) that;
