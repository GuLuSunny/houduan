...
/**
 * 陆浑水库逐日库水位登记表
 * //@TableName tb_water_level
 */
@TableName(value ="tb_water_level")
@Data
public class TbWaterLevel implements Serializable {
    /**
     * 主键
     */
    ...
    * */
    ...
    public TbWaterLevel() {}
    public TbWaterLevel(String waterLevel, String observationTime, Date createTime, String type,
    ...
    public TbWaterLevel(Integer deviceId,String waterLevel,String observationTime,Date createTime,
                        String type,String userName,String filepath,String filename,String createUserid,
                        Integer status,String contactPhone,String contactAddress,String productionUnit,String contactEmail,Integer open,String dataIntroduction) {
    ...
    public boolean equals(Object that) {
        ...
        TbWaterLevel other = (TbWaterLevel) that;
