...
/**
 * 光谱反射率表
 * @TableName spectral_reflectance
 */
@TableName(value ="spectral_reflectance")
@Data
public class SpectralReflectance implements Serializable {
    /**
     * 主键
     */
    ...
    public SpectralReflectance(){};

    public SpectralReflectance(String wavelength,Integer deviceId,String data,String observationTime,Date createTime,String type,
                               String userName,String filepath,String filename,String createUserid,Integer status)
    {
    ...
    public SpectralReflectance(String wavelength,Integer deviceId,String data,String observationTime,
                               Date createTime,String type,String userName,String filepath,
                               String filename,String createUserid,Integer status,String contactPhone,String contactAddress,String productionUnit,String contactEmail,Integer open,String dataIntroduction)
    {
        this.wavelength = wavelength;
        this.deviceId = deviceId.toString();
        this.data = data;
    ...
    public boolean equals(Object that) {
        ...
        SpectralReflectance other = (SpectralReflectance) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
                && (this.getWavelength() == null ? other.getWavelength() == null : this.getWavelength().equals(other.getWavelength()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getWavelength() == null) ? 0 : getWavelength().hashCode());
